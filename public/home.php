        ...
        <div class="container d-flex">
            ...
            <div class="others">
                <?php if (isset($_SESSION['email']) && isset($_COOKIE['session_cookie']) && $_COOKIE['session_cookie'] == session_id()): ?>
                    ...
                    <li><a href="app/frontend/logout.php" data-bs-toggle="tooltip" title="Đăng xuất"><i
                                class="fa-solid fa-right-from-bracket"></i></i></a></li>
                <?php else: ?>
                    <li><a href="app/frontend/faq.php"><i class="fa-solid fa-headphones"></i></a></li>
                    <li><a href="app/frontend/login.php" data-bs-toggle="tooltip" title="Đăng nhập"><i
                                class="fa-solid fa-user"></i></i></i></a></li>
                    <li><a href="app/frontend/register.php" data-bs-toggle="tooltip" title="Đăng kí"><i
    ...
    <main id="main" class="site-main">
        <div class="container">
            <div id="slider" class="carousel slide" data-bs-ride="carousel">
                ...
                <button class="carousel-control-prev justify-content-start ps-3" type="button" data-bs-target="#slider"
                    data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next justify-content-end pe-3" type="button" data-bs-target="#slider"
                    data-bs-slide="next">
                        ...
                        <div class="cartegory-right-content d-flex flex-wrap justify-content-start">
                            <?php foreach ($products as $product):
                                if ($product->category_id == 1):
                                    ...
                                    <div class="cartegory-right-content-item" style="width:20%"
                                        onclick="product_detail(<?= html_escape($product->getId()) ?>)">
                                        <div class="images">
        ...
        <div class="container">
            <div class="main-footer d-flex">
                <div class="left-footer">
                    ...
                    <p><strong>Địa chỉ đăng ký:</strong> đường 3/2, phường Xuân Khánh, Quận Ninh Kiều, thành phô Cần Thơ
                    </p>
                ...
                <div class="right-footer">
                    <div class="register-form">
                        ...
                        <form id="frm_subscribe">
                            <input id="email_subscribe" type="text" name="email" placeholder="Nhập địa chỉ email"
                                required="required">
                            <div class="btn-submit">
                                <input id="btn-submit" class="form-submit button--outline" value="Đăng ký"
                                    type="submit">
                            </div>
                        </form>
                    ...
                    <div class="info-right-ft">
                        ...
                        <ul>
                            <li>
                                <a id="app_ios" href="#" class="link-white" target="_blank"
                                    title="Tải App 2N trên App Store"> <img
                                        src="https://pubcdn.ivymoda.com/ivy2/images/appstore.png" class="img-fluid"
                                        alt=""> </a>
                            </li>
                            <li>
                                <a id="app_android" href="#" class="link-white" target="_blank"
                                    title="Tải App 2N trên Google Play"> <img
                                        src="https://pubcdn.ivymoda.com/ivy2/images/googleplay.png" class="img-fluid"
                                        alt=""> </a>
                            </li>
                        </ul>
                    </div>
